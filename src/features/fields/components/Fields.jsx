    ...
    return (
        <div className="p-4">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-8">
                ...
                {/* BOTÓN CORREGIDO: Ahora tiene onClick */}
                <button 
                    className="bg-main-blue px-4 py-2 rounded text-white hover:opacity-90 transition"
                    onClick={() => {
                        setSelectedField(null); // Importante: null indica que es un campo nuevo
                        setOpenModal(true);
                    }}
                >
                    + Agregar Campo
            ...
            {/* COMPONENTE MODAL: Movido fuera del loop para que solo exista uno */}
            <FieldModal
                isOpen={openModal}
                onClose={() => {
                    setOpenModal(false);
